...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			<li class="nav-item">
				<a class="nav-link" href="<?php echo base_url('Country'); ?>">
			...
			<!-- Nav Item - Pages Collapse Menu -->
			<li class="nav-item">
				<a class="nav-link" href="<?php echo base_url('Game'); ?>">
					<i class="fas fa-fw fa-file"></i>
					<span>Game</span></a>
			</li>

			<li class="nav-item">
				<a class="nav-link" href="<?php echo base_url('Game_category'); ?>">
					<i class="fas fa-fw fa-bars"></i>
					<span>Game Category</span></a>
			</li>
			<li class="nav-item">
				<a class="nav-link" href="<?php echo base_url('Game_developer'); ?>">
					<i class="fas fa-fw fa-bars"></i>
					<span>Game Developer</span></a>
			</li>
			...
			<li class="nav-item">
				<a class="nav-link" href="<?php echo base_url('Player'); ?>">
					<i class="fas fa-fw fa-bars"></i>
					<span>Player</span></a>
			</li>
			...
			<li class="nav-item">
				<a class="nav-link" href="<?php echo base_url('Game_patch'); ?>">
					<i class="fas fa-fw fa-bars"></i>
					<span>Game Patch</span></a>
			</li>
